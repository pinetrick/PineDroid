package com.pine.pinedroid.debug.http_queue
...
import com.pine.pinedroid.debug.http_queue.list_screen.UploadQueueScreen
...
class UploadQueueActivity: ComponentActivity() {
    ...
    fun MainScreen() {// 1. 创建 NavController
        ...
        Scaffold(
            ...
            NavHost(
                ...
                startDestination = "upload_queue",
                modifier = Modifier.padding(innerPadding)
            ) {
                composable("upload_queue") { UploadQueueScreen(navController) }
